	...
	<div class="container">
		<div class="row">
			<div class="col-xxs-12 col-xs-6 col-sm-7 col-md-9 col-lg-9 text-center-xs">
				<h1 class="section-title-inner"><i class="fa fa-shopping-cart"></i>Корзина</h1>
			</div>
		...
		<div class="row">
			...
			<form class="woocommerce-cart-form" action="<?php echo esc_url( wc_get_cart_url() ); ?>" method="post">
				...
				<div class="col-xs-12 col-sm-12 col-md-9 col-lg-9 cart-left">
						...
						foreach ( WC()->cart->get_cart() as $cart_item_key => $cart_item ) {
							...
							if ( $_product && $_product->exists() && $cart_item['quantity'] > 0 && apply_filters( 'woocommerce_cart_item_visible', true, $cart_item, $cart_item_key ) ) {
								...
								<tr class="cart-product woocommerce-cart-form__cart-item <?php echo esc_attr( apply_filters( 'woocommerce_cart_item_class', 'cart_item', $cart_item, $cart_item_key ) ); ?>">
									...
									<td class="cart-description" data-title="<?php esc_attr_e( 'Product', 'woocommerce' ); ?>">
									<?php
                                    if ( ! $product_permalink ) {
				...
				<div class="cart-footer">
					<div class="box-footer">
						<div class="pull-left"><a href="<?=get_post_type_archive_link('product'); ?>" class="btn btn-default"> <i class="fa fa-arrow-left"></i> &nbsp; Продолжить покупки </a></div>
						<div class="pull-right">
							<button type="submit" class="btn btn-default" name="update_cart" value="<?php esc_attr_e( 'Update cart', 'woocommerce' ); ?>"><i class="fa fa-undo"></i>&nbsp;
