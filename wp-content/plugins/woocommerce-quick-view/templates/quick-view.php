	...
	<div class="product">
		<div class="quick-view-image images">
			...
			<?php else : ?>
				...
				<img src="<?php echo wc_placeholder_img_src(); ?>" alt="<?php _e( 'Placeholder', 'wc_quick_view' ); ?>" />

			<?php endif; ?>

			<a class="quick-view-detail-button button" href="<?php echo get_permalink( $product->get_id() ); ?>"><?php _e( 'View Full Details', 'wc_quick_view' ); ?></a>
