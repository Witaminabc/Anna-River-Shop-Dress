	...
	if ( ! class_exists( 'WC_List_Grid' ) ) {
		...
		class WC_List_Grid {
			...
			function gridlist_toggle_button() {
				...
				$output = sprintf( '<nav class="change-view pull-right"><a href="#" id="grid" title="%1$s" class="grid-view active"><i class="fa fa-th-large"></i> </a><a href="#" id="list" class="list-view " title="%2$s"><i class="fa fa-th-list"></i></a></nav>', $grid_view, $list_view );
				...
				echo remove_action( 'gridlist_toggle_button_output', $output, $grid_view, $list_view );
			}
