    ...
    <div class="col-md-12">
        ...
        <div id="sbbol-collapsible" class="row in collapse<?=($isSbBOLEnabled)?' show':'' ?>">
            ...
            <div class="col-md-5">
                ...
                <div class="info-block very-important" id="if-sbbol-nds-20" style="display: <?= $selected20 ? 'block' : 'none' ?>">
                    <span class="dashicons dashicons-info" aria-hidden="true"></span>
                    <span><?= __('Чтобы соответствовать закону 54-ФЗ, 1 января ставку 20% нужно будет поменять на 22% — новые платежи будут проходить по ней. Если не поменять, возможны вопросы и штрафы от ФНС, а операции придётся исправлять вручную', 'yookassa'); ?></span>
                </div>
            </div>
        </div>
