jQuery(document).ready(function ($) {
    ...
    function address_fields_required_validation_fix() {
        var thisform = $(".woocommerce-checkout"), locale_fields = $.parseJSON(wc_address_i18n_params.locale_fields);
        locale_fields && $.each(locale_fields, function (key, value) {
            ...
            $.each(fids, function (index, fid) {
                ...
                field.hasClass("thwcfd-required") ? field_is_required(field, !0) : field.hasClass("thwcfd-optional") && field_is_required(field, !1)
            })
        })
    }
    ...
    $("select.thwcfd-enhanced-select").selectWoo({
        ...
        thwcfd_public_var.is_override_required && setTimeout(address_fields_required_validation_fix, 500)
    })
});